...
2. Установите необходимые зависимости (рекомендуется использовать виртуальное окружение):
   ...
   ```
   *Примечание:* Команда `playwright install chromium` необходима для работы скрипта автоматического сбора данных. Если вы обновляетесь с предыдущей версии, удалите старый файл базы данных `backend/sql_app.db` для применения новой структуры таблиц.
