  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white p-4 md:p-8 font-sans">
      <div className="max-w-[1400px] mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-2 bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">
            BikeScore
          </h1>
          <p className="text-gray-400 text-sm md:text-base">
            Dynamic Cycling Rating System (Pairwise Anchor Model)
          </p>
        </div>

        {/* Controls and Selectors Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          {/* Controls Container (Age & Gender Filters) */}
